...
namespace HorseRacing.Migrations
{
    ...
    [Migration("20260829231750_AddJockeySharePercentage")]
    partial class AddJockeySharePercentage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HorseRacing.Models.JockeyInvitation", b =>
                {
                    ...
                    b.Property<decimal>("JockeySharePercentage")
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("HorseRacing.Models.PrizeDistributionLog", b =>
                {
                    ...
                    b.Property<decimal>("JockeyAmount")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("HorseRacing.Models.RaceComplaintEvidence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("RaceComplaintId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RaceComplaintId");

                    b.HasIndex("UploadedByUserId");

                    b.HasIndex("RaceComplaintId", "EvidenceSource");

                    b.ToTable("RaceComplaintEvidence");
                });
            ...
            modelBuilder.Entity("HorseRacing.Models.ViolationRecord", b =>
                {
                    ...
                    b.Property<int?>("PenaltyTimeSeconds")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HorseRacing.Models.RaceComplaintEvidence", b =>
                {
                    b.HasOne("HorseRacing.Models.RaceComplaint", "RaceComplaint")
                        .WithMany("Evidence")
                        .HasForeignKey("RaceComplaintId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("HorseRacing.Models.User", "UploadedByUser")
                        .WithMany()
                        .HasForeignKey("UploadedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("RaceComplaint");
