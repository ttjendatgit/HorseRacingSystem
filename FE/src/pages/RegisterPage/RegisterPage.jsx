...
function RegisterPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      navigate("/spectator/tournaments");
    } catch (error) {
      setErrorMessage(
          ...
          <div className="promo-card promo-card--gold" onClick={() => navigate("/register/horse-owner")}>
            <div className="promo-card__inner">
              <div className="promo-card__body">
                ...
                <p className="promo-card__desc">Đăng ký tài khoản Chủ ngựa để quản lý ngựa và tham gia các giải đua.</p>
                <span className="promo-card__cta">Đăng ký ngay</span>
              </div>
              <div className="promo-card__visual promo-card__visual--horse">
                <div className="promo-card__art" style={{ backgroundImage: "url('/images/promo/horse-owner-bg.jpg')" }} />
              </div>
            </div>
          </div>
          ...
          <div className="promo-card promo-card--blue" onClick={() => navigate("/register/jockey")}>
            ...
            <div className="promo-card__inner">
              <div className="promo-card__body">
                ...
                <p className="promo-card__desc">Đăng ký để tham gia thi đấu và chinh phục những đường đua chuyên nghiệp.</p>
                <span className="promo-card__cta">Đăng ký ngay</span>
              </div>
              <div className="promo-card__visual promo-card__visual--jockey">
                <div className="promo-card__art" style={{ backgroundImage: "url('/images/promo/jockey-bg.jpg')" }} />
              </div>
            </div>
          </div>
        </div>
