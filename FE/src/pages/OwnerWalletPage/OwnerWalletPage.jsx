...
import { getBalance, getMyPrizeHistory } from "../../services/walletApi";
import { formatVndCurrency } from "../../utils/prizeAllocation";
import "./OwnerWalletPage.css";
  ...
  return (
    <div className="ow-page">
      <div className="ow-topbar">
        <div>
          <h1>Ví của tôi</h1>
          <p className="ow-topbar-sub">Số dư khả dụng và lịch sử nhận thưởng theo thứ hạng chung cuộc.</p>
        </div>
      </div>
      ...
      <section className="ow-history" aria-label="Lịch sử nhận thưởng">
        ...
        {historyLoading ? (
          ...
          <div className="ow-empty">
            ...
            <p>Tham gia giải đấu và về đích ở vị trí cao để nhận thưởng.</p>
          </div>
        ) : (
                ...
                <li key={`${tournamentId}-${position}-${i}`} className="ow-card hover-lift">
                  ...
                  <div className="ow-card__body">
                    ...
                    <p className="ow-card__horse">
                      Ngựa về đích: <strong>{horseName}</strong>
                    </p>
